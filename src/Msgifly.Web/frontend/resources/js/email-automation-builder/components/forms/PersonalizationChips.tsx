...
/** Inserts a {{subscriber.*}} token at the cursor position of the associated field (not just
 * appended), matching EmailMergeTagRenderer's supported placeholders. Identical to the WhatsApp
 * canvas's PersonalizationChips, just pointed at Email's own token set. */
