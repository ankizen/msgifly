...
public record TemplateOption(string TemplateId, string Name, string? HeaderFormat, int HeaderParamsCount, int BodyParamsCount, int FooterParamsCount, string BodyText = "");
